...
started in the morning 13/08/2022 i forgor but between 08:30 and 09:00
its now 09:25, i fixed the paladin animations
its 19:57, I think I'm losing my motivation
discovered a new song tho, which kinda motivates me?
I know what will motivate me
https://www.youtube.com/watch?v=Jrg9KxGNeJY&ab_channel=%E3%83%87%E3%83%93%E3%83%AB%E3%83%8F%E3%83%B3%E3%82%BF%E3%83%BChunter
Its 20:17, fuck this i want to play games. I gotta stop this madness.
...
def combat_choice(team1, team2, turn):#player, player_team, enemy_team
    #if turn < len(team1):


def combat(team1, team2, turn):
    turns = []
    turns.append(team1)
    turns.append(team2)
