...
started in 27/08/2022 08:08
i made a program to myself which means that i will start working at 8 am
its 9 am rn, i feel like i did a good job, i did some of the combat things
its 17:39, i kinda couldnt do the study parts of my program lmao
lets go.
its 18:26 rn, i did the placements of the combat and the system to switch to the combat mode(barely, ui is not done)
...
for button in da_list:
    buttons.append(Button(monitor_size[0] * 0.39, monitor_size[1] * 0.78 + the_step, monitor_size[0] * 0.22, 0.20 / (len(da_list) + 1), button))
    the_step += 0.20 / len(da_list)
