...
its 00:14 29/07/2022
what am i doing with my life?
anyways this is kind of me continuing directly the last part?
the tff file worked
i actually have to do the dialogue thing but i want to test the new animations so bad
at least i can start by doing the asset file thing so the file itself wont be messy


img_with_flip = pygame.transform.flip(img, True, False)

this mf can actually mirror the image, at least now i know this


its 00:42, all i did was to set the files so they are proper, get the button function and fix the bandit images
to do list:
...
Note: the code rn doesnt work bc image locations
"""
import pygame
import os
...
"""
#assets//UI//
game_title = pygame.image.load("assets//UI//Game_Title.png")
background = 
