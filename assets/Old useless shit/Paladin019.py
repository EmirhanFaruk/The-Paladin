...
started in 26/08/2022 22:56 or smtg
https://www.youtube.com/watch?v=LcI8sfwxvIs&ab_channel=CarpenterBrut-Topic
cant fucking stop vibing to this
i realized i gotta make a function that puts the text in the middle and not the left
im just gonna add a parameter to differ the middle/left based ones to the current function, what could go wrong?
smh mfs from the server trolled me when i was vibin in single sex
its 23:45 rn
...
def get_images(name, nickname = ""):
    ...
    #getting text name
    img_list.append(D_Text(monitor_size[0] * 0.05 , monitor_size[1] * 0.94, nickname, 50, (0, 0, 0), monitor_size[0] * 0.69, "middle"))#its actually too much but idc tbh it wont be seen in the game i hope
